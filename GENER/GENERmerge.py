...
def addGener():
    ...
    print(generline)    
    print(fillstring(EL.get(),3), end="")
    print(fillstring(NE.get(),2), end="")
    print(fillstring(SL.get(),3), end="")
    print(fillstring(NS.get(),2), end="")
    print(fillstring(NSEQ.get(),5), end="")
    print(fillstring(NADD.get(),5), end="")
    print(fillstring(NADS.get(),5), end="")
    print(fillstring(LTAB.get(),5), end="")
    print(fillstring("",5), end="")
    print(fillstring(TYPE.get(),4), end="")
    print(fillstring(ITAB.get(),1), end="")
    print(fillstring(GX.get(),10), end="")
    print(fillstring(EX.get(),10), end="")
    print(fillstring(HG.get(),10), end="")#HX??
    print()
    separate(F1.get(),10)
    print()
    separate(F2.get(),10)
